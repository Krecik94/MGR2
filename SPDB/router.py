...
class way():
    def __init__(self, id):
        self.id = id
        print
        "new way with id: " + self.id + " created"
...
class connection():
    def __init__(self, wayId, node1, node2):
        ...
        print
        " Connection between: " + node1.id + " and " + node2.id + " created"

    def printConnection(self):
        print
        "Saved Connection between: " + self.node1.id + " and " + self.node2.id + "! "
...
class node():
    def __init__(self, id, lat, lon):
        ...
        self.known = False
        print
        "new node with id: " + self.id + " created"
        print
    ...
    def printConnections(self):
        print
        self.id + " has " + str(len(self.connections)) + " connecitons they are:"
...
class routingDb():
    ...
    def printStatus(self):
        ...
        for i in self.listOfNodes:
            print
            "Node " + str(i) + " is in da DB it has: " + str(self.listOfNodes[i].numOfConnections()) + " Connection(s)"
